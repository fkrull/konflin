...
interface ConfigSpec {
    ...
    fun <T : Any> setting(
        ...
        String::class -> ConverterBasedSetting<String>(name, defaultValue as String?, IdentityConverter(ConfigType.Types.String))
        Int::class -> ConverterBasedSetting<Int>(name, defaultValue as Int?, IdentityConverter(ConfigType.Types.Int))
        Boolean::class -> ConverterBasedSetting<Boolean>(name, defaultValue as Boolean?, IdentityConverter(ConfigType.Types.Boolean))
